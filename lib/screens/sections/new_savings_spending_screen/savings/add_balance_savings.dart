...
class AddBalanceSavingsScreen extends StatelessWidget {
  Savings savings;
  User user;
  AddBalanceSavingsScreen(this.savings, this.user, {super.key});
          ...
          slivers: [
            const SliverToBoxAdapter(
              child: Padding(
                ...
                child: Text(
                  'Quanto você deseja adicionar a sua poupança?',
                  style: TextStyle(
                    fontSize: 28,
                    letterSpacing: 0.75,
